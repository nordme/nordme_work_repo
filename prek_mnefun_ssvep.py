...
# skip = ['prek_1259', 'prek_1451', 'prek_1401', 'prek_1112', 'prek_1443', 'prek_1940', 'prek_1951']
...
# params.subject_indices = np.setdiff1d(np.arange(len(params.subjects)), np.arange(42))
...
params.trans_to = 'twa'    #  (0., 0., 0.04)  # time weighted average or fixed head position (change this to fixed pos for sensor analysis)
...
# params.run_names = ['%s_pskt_01_post', '%s_pskt_03_post']
